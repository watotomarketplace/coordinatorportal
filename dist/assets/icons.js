(() => {
  ...
  var CalendarCheck = createLucideIcon("calendar-check", __iconNode3);
  ...
  var ChartNoAxesColumn = createLucideIcon("chart-no-axes-column", __iconNode4);
  ...
  var Clipboard = createLucideIcon("clipboard", __iconNode9);
  ...
  var Flag = createLucideIcon("flag", __iconNode14);
  ...
  var Key = createLucideIcon("key", __iconNode20);
  ...
  var Layers = createLucideIcon("layers", __iconNode21);
  ...
  var LogOut = createLucideIcon("log-out", __iconNode22);
  ...
  var Pen = createLucideIcon("pen", __iconNode24);
  ...
  var TrendingDown = createLucideIcon("trending-down", __iconNode33);
  ...
  function toSVG(Component, size = 20, strokeWidth = 1.75) {
    return (0, import_server.renderToStaticMarkup)(
      (0, import_react4.createElement)(Component, { size, strokeWidth, style: { display: "block" } })
    );
  }
  window.__ICONS__ = {
    home: toSVG(House),
    ...
    analytics: toSVG(ChartNoAxesColumn),
    ...
    bell: toSVG(Bell),
    search: toSVG(Search),
    checkCircle: toSVG(CircleCheckBig),
    warning: toSVG(TriangleAlert),
    error: toSVG(CircleX),
